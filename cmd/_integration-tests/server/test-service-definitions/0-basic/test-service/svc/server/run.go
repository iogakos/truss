...
import (
	...
	"github.com/metaverse/truss/cmd/_integration-tests/server/test-service-definitions/0-basic/test-service/handlers"
...
func NewEndpoints() svc.Endpoints {
	...
	// Endpoint domain.
	var (
		getbasicEndpoint  = svc.MakeGetBasicEndpoint(service)
		postbasicEndpoint = svc.MakePostBasicEndpoint(service)
	)
